(function(angular) {
    ...
    function factory(Helper, $q) {
        ...
        function initialize(source, data, width, height) {
            ...
            source.src.indexOf('jpg') > -1 ? image.onload = cropHandler('image/jpeg') : image.onload = cropHandler('image/png'); 
        ...
        function cropHandler(ext) {
            ...
            imageCropped = canvas.toDataURL(ext);
